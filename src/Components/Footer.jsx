export default function Footer() {
    return (
        <footer className="footer-container flex flex-col justify-between items-center border bg-black h-[440px]">
            <div className="footer flex justify-evenly border border-red-500 w-[1170px] h-[236px] mt-[80px]">
                <div className="footer-upper flex justify-between border border-red-500 w-[500px]">
                ...
                <div className="footer-lower flex justify-between w-[600px] border border-red-500 max-w-50%">
