    ...
    return (
        <header className="bg-white lg:py-8 ">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 md:px-4 lg:px-8">
                {/* Desktop Navigation */}
                <nav className="relative flex items-center justify-between h-16  bg-white lg:rounded-md md:shadow-lg lg:shadow-lg md:h-20 lg:h-24 md:py-4 md:px-10 lg:px-8 lg:py-6 border border-red-500">
                    ...
                    <button
                        ...
                        type="button"
                        className="border border-red-600 inline-flex p-2 ml-5 text-black transition-all duration-200 rounded-md md:hidden lg:hidden focus:bg-gray-100 hover:bg-gray-100"
                    >
                        {expanded ? (
                            // Close Icon
                            <svg
                    ...
                    {/* Desktop Menu Links */}
                    <div className="hidden md:px-4 md:flex md:items-center md:mx-auto md:space-x-5 lg:flex lg:items-center lg:mr-auto lg:space-x-10 border border-blue-600">
                    ...
                    <div className="hidden ml-0 lg:ml-10 justify-between md:flex md:items-center md:-mr-1 lg:-mr-1 md:mr-auto lg:flex lg:items-center   border md:w-[270px] lg:w-[350px] border-blue-400">
                        ...
                        <div className="flex items-center justify-between p-1 md:w-[60px] lg:w-[80px] border border-red-400">
