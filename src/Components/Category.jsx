export default function Category({ prop }) {
    return (
        <div className="flex justify-center  items-center category w-[1170px] bg-black h-[500px]">
            <div className="flex flex-col justify-evenly w-[450px] h-[92%] ">
            ...
            <div className=" flex justify-center items-center h-[420px] w-[600px]">
