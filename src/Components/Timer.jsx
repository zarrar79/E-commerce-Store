    ...
    return (
        <>
            {prop.timerComponent === 1 ? (
                ...
                <div className="flex justify-between w-[200px] md:w-[300px]">
                    {["Days", "Hours", "Minutes", "Seconds"].map((label, index) => (
                        <div key={index} className="flex flex-col justify-center w-[40px] h-[40px] md:w-[60px] md:h-[60px] items-center rounded-full bg-white">
